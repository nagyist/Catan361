Painted 2D Medieval-Fantasy Hex Locations
...
Last Update: v1.1 in March 2016
...
- expands upon my "Pained 2D Terrain Tiles: Basic Set" for those interested in making medieval-fantasy games
- 53 tiles (21 unique location types, some on different terrain types, some with multiple variations)  
...
- temple (on plains)
- a ruined temple (on plains, dirt)
